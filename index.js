...
document.querySelector(".Eye").addEventListener("click", (e) => {
  ...
  e.target.classList.value.includes("fa-eye-slash")
  ...
  const writeBasket = () => {
    ...
    $(".clearCart").click(function (e) {
      ...
      if (
        ...
        document
          .querySelector(".Product-details .productImg")
          .getAttribute("id") == clearedID
      ) {
        document.querySelector(".Product-details .btn-add").innerText =
          "ADD TO CART";
      }
    });
  };
